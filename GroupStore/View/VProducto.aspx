                            ...
                            <div class="col-12 col-md-12 col-lg-10 my-4 bg-secondary bg-opacity-10 shadow rounded-3 pt-1 pb-2 ">
                                ...
                                <div class="row mt-1">
                                    <div class="col-12 col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="I_nombreProducto" placeholder="Nombre de producto" runat="server" />
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="I_Shock">Stock del producto</label>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label ms-1 mb-2 h6">Imagenes del producto (sólo 3 imagenes)</label>
                                            <asp:FileUpload ID="FU_Imagenes" runat="server" AllowMultiple="true" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <div class="form-floating mb-3">
                                ...
                                <div class="row mt-2">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="I_Descripcion" rows="2" class="form-control" runat="server"></textarea>
                                    </div>
                                </div>
                                <hr />
                                <div class="row justify-content-center">
                                    <a class="btn btn-danger me-2 col-4" href="VProductos.aspx">Cancelar</a>
                                    <button type="button" class="btn btn-success ms-2 col-4" runat="server" id="btn_aggProducto" onserverclick="btn_aggProducto_ServerClick">Agregar producto</button>
                                </div>
                            </div>
                        </div>
                    </form>
